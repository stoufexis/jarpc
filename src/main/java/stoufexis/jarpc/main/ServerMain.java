...
public class ServerMain {
  ...
  //      int code = callback.onResponse(clientId, correlationId, true, response);
  ...
  //  }
  //
  //  record InternalError(long clientId, long correlationId, int errorCode) {}
  ...
  static void main() {
    ...
    //            System.out.println(new InternalError(clientId, correlationId, errorCode));
    //          }
    //
    //          @Override
